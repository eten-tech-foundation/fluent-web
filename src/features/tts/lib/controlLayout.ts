...
/** Kept mounted for keyboard reveal; touch cannot depend on hover. */
export const VERSE_CONTROL_REVEAL_CLASS =
  'absolute top-1/2 left-8 z-10 -translate-y-1/2 rounded-full bg-background opacity-0 transition-opacity group-hover/audio:opacity-100 group-focus-within/audio:opacity-100 [@media(hover:none)]:opacity-100';
