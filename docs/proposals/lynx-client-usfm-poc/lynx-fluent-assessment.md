...
**Companion to:** [`design.md`](design.md) (the PoC on this branch) · the running demo at `/lynx-usfm` (authenticated route).
...
## 3. What the PoC on this branch proves

Run it: `/lynx-usfm` (any authenticated user; sample loads automatically, "Assemble chapter → USFM" pulls live data).
